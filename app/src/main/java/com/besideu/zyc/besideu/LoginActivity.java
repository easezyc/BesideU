...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailSignInButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                attemptLogin("http://202.112.88.39:8080/android/servlet/LoginSvt");
            }
        });
        ...
        mEmailRegisterButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                attemptLogin("http://202.112.88.39:8080/android/servlet/RegisterSvt");
            }
        });
    ...
    private void getUser(){
        try{
            final String DATABASE_NAME="myuser";

            boolean flag=false;
            String[] list=databaseList();
            for(int i=0;i<list.length-1;i++){
                if(DATABASE_NAME.equals(list[i])){
                    flag=true;
                    break;
                }
            }
            if(flag==true){
                ...
                mEmailView.setText(s_email);
                mPasswordView.setText(s_pwd);
            }
        }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            formparams.add(new BasicNameValuePair("pwd",mPassword));
            ...
            if (response.getStatusLine().getStatusCode() == 200) {
                try{result = EntityUtils.toString(response.getEntity());}
                catch (Exception e){
                    e.printStackTrace();
                }
        ...
        public void createDatabase(){
            try{
                ...
                SQLiteDatabase db=openOrCreateDatabase(DATABASE_NAME,MODE_PRIVATE,null);
                if(flag==false){
                    db.execSQL("CREATE TABLE "+TABLE_NAME+" (email varchar(30),pwd varchar(30))");
                }
                db.execSQL("DELETE FROM "+TABLE_NAME);
                db.execSQL("INSERT INTO "+TABLE_NAME+" VALUES ('"+mEmail+"','"+mPassword+"')");
            }
            catch(SQLException e){
                e.printStackTrace();
            }
